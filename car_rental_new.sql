...
INSERT INTO `cars` (`id`, `user_id`, `make`, `model`, `prod_year`, `available`, `driveing_licence`, `pictures`, `trunk_space`, `daily_rate`, `deposit`, `licence_plate`, `fuel_type`, `doors_number`, `air_con`, `seats_number`, `gearbox_type`) VALUES
(6, 1, 'Toyota', 'Corolla', 2020, 1, 'B', 'car1.jpg,car2.jpg,car3.jpg', 350, 45.00, 200.00, 'TBC-863', 'Benzin', 5, 1, 5, 'Manuális');
...
(1, 'adsa', 58, 'asdasdasdasdasd', NULL, 0, '0000-00-00 00:00:00.000', 'rakosmakos');
